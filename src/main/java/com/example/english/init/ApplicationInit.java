...
public class ApplicationInit implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (grammarCategoryService.getCount() == 0) {
            ...
            User wow_moderator = mapper.map(userService.getUserByName("wow_moderator"), User.class);
            Role role_moderator = roleService.getRoleByName("ROLE_MODERATOR");
            Role role_admin = roleService.getRoleByName("ROLE_ADMIN");

            wow_moderator.getAuthorities().addAll(
                    new ArrayList<>() {{
                        add(role_moderator);
                        add(role_admin);
                    }}
            ...
            userService.updateUser(wow_moderator);
        }
    }
    ...
    private static List<UserServiceModel> users() {
        return Arrays.asList(
                ...
                //MODERATOR && ADMIN
                new UserServiceModel("wow_moderator", "wow", "wow@wow.wow"),
    ...
    private Content[] contents() {
        return new Content[]{
                Content.builder()
                        ...
                        .author(mapper.map(userService.getUserByName("fizz"), User.class))
                        .build(),
                Content.builder().title("Where can I get some?")
                        .difficulty(randomLevel())
                ...
                Content.builder()
                        ...
                        .author(mapper.map(userService.getUserByName("Bai ИВАН"), User.class))
                        .build(),
                Content.builder()
                        ...
                        .author(mapper.map(userService.getUserByName("wow_moderator"), User.class))
                        .build(),
                Content.builder()
                        .title("Neque porro quisquam est quid")
                        .difficulty(randomLevel())
                        ...
                        .author(mapper.map(userService.getUserByName("zxc"), User.class)).build()
        };
    }
